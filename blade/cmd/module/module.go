...
func (m *Module) namingDirPath(dir, name string) string {
	return dir + "/" + strutil.ToUnderlineNaming(name)
}

func (m *Module) namingFilePath(dir, name string) string {
	return dir + "/" + strutil.ToUnderlineNaming(name) + ".go"
}
